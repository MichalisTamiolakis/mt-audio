...
{
public:
    MultiplexedButton(uint8_t buttonType, uint8_t pin0, uint8_t pin1, uint8_t pin2, uint8_t pin3, uint8_t pin4, uint8_t buttonCode, uint32_t debounceDelay, uint32_t functionDelay);
    void loop();
